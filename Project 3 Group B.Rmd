...
## 1. Boxplot for log shares subdivided by days.
...
## 2. Scatterplot for log shares and number of images
...
## 3. Scatterplot for log shares and number of videos.
...
## 5. Scatterplot for number of unique tokens and log shares
...
## 6. Scatterplot for number of tokens content and log shares
...
## 7. Scatterplot for number of token titles and log shares
...
FUN = function(x){
render(input = "project 3.Rmd", output_file = x[[2]], params = x[[3]])
})
```
