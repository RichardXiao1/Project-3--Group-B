...
ggplot(subjectivityData, aes(x = global_subjectivity, y = sharecount)) +
geom_point() +
ggtitle("Count of Rented Bikes for each hour")
```
...
ggplot(sentimentpolarityData, aes(x = global_sentiment_polarity, y = sharecount)) +
geom_point() +
ggtitle("Count of Rented Bikes for each hour")
```
...
ggplot(positivewordsData, aes(x = global_rate_positive_words, y = sharecount)) +
geom_point() +
geom_smooth(method = "lm") +
ggtitle("Count of Rented Bikes for each hour")
```
