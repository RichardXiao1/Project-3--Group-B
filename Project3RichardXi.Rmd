...
FUN = function(x){
render(input = "project3RichardXi.Rmd", output_file = x[[2]], params = x[[3]])
})


reports <- tibble(output_file = stringr::str_c("C:/Users/richa/OneDrive/Documents/ST 558/Project 3/Project -3--Group B/Project-3--Group-B", channelIDs, "-analysis.html"),params = map(channelIDs, ~list(channelIDs = .)))


reports %>% pwalk(rmarkdown::render, input = "Project3RichardXi.Rmd")
